...
const { 
    getUserById, createUser, createSeller, getSellerById, createProduct, 
    getProductById, addToCart, removeFromCart, getCart, placeOrder, 
    updateOrderStatus, getSellerOrders, getUserOrders, getOrderById, 
    signInUser, getAllProducts 
} = require("./client"); 
...
app.post("/api/v1/seller/signup", async (req,res) => {
    ...
    const userData = { email, password, businessName, phoneNumber };
...
app.post("/api/v1/product", async (req, res) => {
    ...
    const productData = { name, description, category, price, sellerId, stockQuantity, imageUrl };
